...
```
![plot1](https://github.com/JavierRosales/RepData_PeerAssessment1/blob/master/Plots/plot2_.png)
...
```
![plot1](https://github.com/JavierRosales/RepData_PeerAssessment1/blob/master/Plots/plot3_.png)
...
```
![plot1](https://github.com/JavierRosales/RepData_PeerAssessment1/blob/master/Plots/plot4_.png)
